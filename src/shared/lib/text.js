module.exports = {
	'Menu': [
		// { route: 'Home'},
		{ route: 'About Us', hash: 'about'},
		{ route: 'Weddings', hash: 'weddings'},
		{ route: 'Schools & Groups', hash: 'schools-groups'},
		{ route: 'Video tape conversions', hash: 'video-tape-conversions'},
		{ route: 'Photo slide conversions', hash: 'photo-slide-conversions'},
		// { route: 'FAQs', hash: 'faq'},
		{ route: 'Contact Us', hash: 'contact'}
	],
	'General': {
		'AVE': 'A-Team Media',
		'Address': '20 Le Roux Drive, Oldmeldrum, Aberdeenshire, Scotland, AB51 0PJ',
	...
	'Blog': [
		...
		},
		{
			...
			'Video': 'https://mediazilla.com/oozmx0zG1'
		},
		{
			'Location': 'Brodie Castle & Mosset Tavern',
			'Video': 'https://mediazilla.com/ooy34k3h1'
		},
		{
			'Location': 'Kings College & Buchan Braes',
			'Video': 'https://mediazilla.com/xoxo4a6O6'
		},
		{
			'Location': 'Pittodrie House',
			'Video': 'https://mediazilla.com/Kotnz09X0'
		}
	],
	'ContactUs': {
		'Subjects': [
			'-- Please choose a subject --', 'Weddings', 'Schools & Groups', 'Video tape conversions', 'Photo slide conversions'
		]
	},
	'FAQ': [
		{
