...
const Weddings = () => (
	<div className='row'>
		<div className={`col-xs-12 col-md-6 ${styles.content}`}>
			...
			<p>We will never ask you or your partner to stage shots either - again it’s not our style. We like to provide you with a film of your day as it unfolds. This will allow you to relive your day again and again and also see the parts the you never got to see on the day.  We won’t follow the photographer around as its their job to get this personal photos with you.  We will capture some elements of that for the purposes of documenting your day.</p>
		...
		<div className='col-xs-12 col-md-6'>
			<img className={styles.img} src='https://s3.eu-west-2.amazonaws.com/latitude55-website-resources/a-team-media/wedding_v2.jpg' />
		</div>
	</div>
);
