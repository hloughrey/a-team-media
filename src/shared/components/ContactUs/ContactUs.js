...
class ContactUs extends React.Component {
        ...
        switch (e.target.name) {
            ...
            case 'subject':
                newValue = {
                    ...
                    subjectValid:
                        e.target.value !== '-- Please choose a subject --' &&
                        true
                };
                break;
            case 'telephone':
    ...
    renderErrorAlert() {
        return (
            <div className="alert alert-dismissible alert-danger">
                <strong>Oh snap!</strong> We're really sorry about this, but it
                looks like there was an error. Please try again or message us
                using traditional email at info@a-team-media.co.uk
            </div>
        );
    }
    ...
    renderSuccessAlert() {
        return (
            <div className="alert alert-dismissible alert-success">
                <strong>Awesome sauce!</strong> We appreciate your message and
    ...
    isSubmitButtonDisabled() {
        return !Object.keys(this.state)
            .filter(i => i.endsWith('Valid'))
            .every(i => this.state[i]);
    }
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-md-6">
                            <img
                                ...
                                src={`${cloudinary}/v1533586252/a-team-media/contact.jpg`}
                            />
                        </div>
